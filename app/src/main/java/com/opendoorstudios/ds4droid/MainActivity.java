...
public class MainActivity extends Activity implements OnSharedPreferenceChangeListener {
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        for (int i = 1; i <= 10; ++i) {
            ...
            switch (i) {
                case 1:
                    saveItem = menu.findItem(R.id.save1);
                    loadItem = menu.findItem(R.id.restore1);
                    break;
                case 2:
                    saveItem = menu.findItem(R.id.save2);
                    loadItem = menu.findItem(R.id.restore2);
                    break;
                case 3:
                    saveItem = menu.findItem(R.id.save3);
                    loadItem = menu.findItem(R.id.restore3);
                    break;
                case 4:
                    saveItem = menu.findItem(R.id.save4);
                    loadItem = menu.findItem(R.id.restore4);
                    break;
                case 5:
                    saveItem = menu.findItem(R.id.save5);
                    loadItem = menu.findItem(R.id.restore5);
                    break;
                case 6:
                    saveItem = menu.findItem(R.id.save6);
                    loadItem = menu.findItem(R.id.restore6);
                    break;
                case 7:
                    saveItem = menu.findItem(R.id.save7);
                    loadItem = menu.findItem(R.id.restore7);
                    break;
                case 8:
                    saveItem = menu.findItem(R.id.save8);
                    loadItem = menu.findItem(R.id.restore8);
                    break;
                case 9:
                    saveItem = menu.findItem(R.id.save9);
                    loadItem = menu.findItem(R.id.restore9);
                    break;
                case 10:
                    loadItem = menu.findItem(R.id.restoreauto);
                    break;
            }
    ...
    void scheduleAutosave() {
        ...
        if (prefs.getBoolean(Settings.ENABLE_AUTOSAVE, true)) {
            ...
            switch (freqSel) {
                case 0:
                    autosaveDelay = 60 * 1000;
                    break; //1 minute
                case 2:
                    autosaveDelay = 15 * 60 * 1000;
                    break; //15 minutes
                case 3:
                    autosaveDelay = 30 * 60 * 1000;
                    break; //30 minutes
                case 4:
                    autosaveDelay = 60 * 60 * 1000;
                    break; //1 hour
                default:
